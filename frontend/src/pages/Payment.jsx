    ...
    <div className="min-h-screen bg-gray-950">
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="grid md:grid-cols-3 gap-6">
          ...
          {/* Order Summary */}
          <div>
            <Card className="p-6 sticky top-6 bg-gray-900 border-gray-800">
              ...
              <div className="space-y-3 mb-4">
                <div className="flex items-start space-x-3">
                  ...
                  <div className="flex-1">
                    <h4 className="font-semibold text-sm text-white">{movie.title}</h4>
                    <p className="text-xs text-gray-400">{showtime.theater.name}</p>
                    <p className="text-xs text-gray-400">{showtime.time}</p>
                  </div>
                </div>
              </div>
              ...
              <div className="border-t border-gray-800 mt-3 pt-3">
                <div className="flex justify-between">
                  ...
                  <span className="font-bold text-xl text-red-500">₹{grandTotal}</span>
                </div>
              </div>
